...
const BeyondLudicrious =()=>{
    ...
    return(
        ...
        <div className="h-[500px] relative ">
            <Image src='/modelX/X10.jpg' layout='fill' objectFit='cover'/>
        ...
        <motion.div variants={variant1} initial='hidden' animate={TopicControls} className="lg:flex">
            <div className="ml-10 my-8 lg:ml-[100px] xl:ml-[150px] mr-[100px]" ref={TopicRef}>
                ...
                <p className="font-bold text-3xl">BeyondLudicrious</p> 
            ...
            <div className="ml-10 mr-3  max-w-4xl lg:my-auto ">
                <p className="text-sm">Model S Plaid has the quickest acceleration of any vehicle in production. Updated battery architecture for all Model S trims enables back-to-back track runs without performance degradation.</p>
            </div>
