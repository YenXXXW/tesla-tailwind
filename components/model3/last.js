            ...
            <div className="mx-auto lg:w-2/5" ref={TopicRef}>
                ...
                <div className="flex flex-col lg:flex-row ">
                    <motion.button  variants={variant2} initial='hidden' animate={TopicControls}
                     className=" w-5/6 rounded-full text-sm bg-white text-gray-800  hover:bg-gray-800 hover:text-white hover:font-normal md:w-[250px] lg:w-[250px] lg:mr-20"
                    >
                        ORDER NOW
                    </motion.button>
                    <motion.button  variants={variant3} initial='hidden' animate={TopicControls}
                     className=" w-5/6 rounded-full text-sm  border-[4px] mt-4 border-gray-800 hover:bg-gray-800 hover:text-white hover:font-normal md:w-[250px] lg:mt-0 lg:w-[250px]"
                    >
                        Compare
                    </motion.button>
                </div>
