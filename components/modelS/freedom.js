                ...
                <div className={map === a ? "block" : "hidden"}>
                    <div className="w-full  absolute z-30  ">
                        <svg xmlns= 'http://www.w3.org/2000/svg' viewBox="0 0 1225 562" className="absolute " ref={mapRef1}>                        
                            ...
                            <circle r='4' cx='620' cy='470' stroke="black" strokeWidth={'2px'}/>
                            <motion.path  variants={variant5} initial='hidden' animate={mapControls1}
                              d='M624 470 l12 -8 v16 l-12 -8' fill='red' stroke='red' strokeWidth='1px'/>
                        </svg> 
                    </div>  
                    <motion.div variants={variant5} initial='hidden' animate={mapControls1}
                     className="bg-[#ff0000] z-30 absolute bottom-[14.5%] left-[52%] px-[2%] 
                ...
                <div  className={map === b ? "block" : "hidden"}>
                    <div className="w-full absolute z-30  ">
                        <svg xmlns= 'http://www.w3.org/2000/svg' viewBox="0 0 1225 562" className="absolute " ref={mapRef2}>                        
                            ...
                            <circle r='4' cx='923' cy='103' stroke="black" strokeWidth={'2px'}/>
                            <motion.path variants={variant5} initial='hidden' animate={mapControls2}
                              d='M923 107 l5 8 h-10' fill='red' stroke='red' strokeWidth='1px'/>
                        </svg> 
                    </div>
                    <motion.div variants={variant5} initial='hidden' animate={mapControls2}
                     className="bg-[#ff0000] z-30 absolute top-[20%] right-[20%] px-[2%] 
                    py-[0.5%] text-xxs sm:text-xs text-white md:px-[1%] md:text-sm md:font-bold 
                    tracking-wider ">
                        178 miles
                    </motion.div>    
                ...
                <div  className={map === c ? "block" : "hidden"}>
                    <div className="w-full absolute z-30  ">
                        <svg xmlns= 'http://www.w3.org/2000/svg' viewBox="0 0 1225 562"  className="absolute " ref={mapRef3}>                        
                            ...
                            <circle r='4' cx='825' cy='45' stroke="black" strokeWidth={'2px'}/>
                            <motion.path variants={variant6} initial='hidden' animate={mapControls3}
                             d='M807 39 l13 6 l-13 6' fill='red' stroke='red' strokeWidth='1px'/>
                        </svg> 
                    </div>
                    <motion.div variants={variant6} initial='hidden' animate={mapControls3}
                     className="bg-[#ff0000] z-30 absolute top-[5%] right-[34%] px-[2%] 
                    py-[0.5%] text-xxs sm:text-xs text-white md:px-[1%] md:text-sm md:font-bold 
                    tracking-wider ">
                        211 miles
                    </motion.div>
