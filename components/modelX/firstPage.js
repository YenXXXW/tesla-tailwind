...
const FirstPage = () => {
    ...
    return (
        ...
        <Navbar fill={'black'} position={'absolute'}/>
            <Image src={'/modelX/X1.jpg'} layout='fill' objectFit="cover"/>
             ...
             px-3 lg:flex-row lg:px-48">
                <div className="flex justify-around md:w-[70%] md:mx-auto">
                    <motion.div variants={variant1} initial='hidden' animate={specControls}>
                        <p className="text-center text-lg sm:text-2xl xl:text-4xl ">333mi</p>
                    ...
                    <motion.div  variants={variant2} initial='hidden' animate={specControls}>
                        <p className="text-center text-xl xs:text-2xl xl:text-4xl ">2.5s</p>
                    ...
                    <motion.div className="hidden sm:block"  variants={variant3} initial='hidden' animate={specControls}>
                        <p className="text-center text-xl xs:text-2xl xl:text-4xl ">9.9s</p>
                        <p className="text-center mt-2 text-xs font-normal lg:text-sm ">1/4 Mile</p>
                    </motion.div>
